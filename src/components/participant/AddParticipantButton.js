...
import { TextField, Stack, Alert, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Button, Box } from '@mui/material'
...
function AddParticipantButton({ userId }) {
    ...
    const [createParticipant, { loading, error }] = useMutation(CREATE_PARTICIPANT, {
        ...
        <>
            ...
            <Dialog open={open} onClose={handleClose}>
                <Formik
                    ...
                    onSubmit={values => {
                        createParticipant({ variables: { participantInput: { ...values, userId } } })
                        handleClose()
                    }}
                >
